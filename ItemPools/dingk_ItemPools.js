...
var dingk = dingk || {};
dingk.ItemPools = dingk.ItemPools || {};
 ...
 * @default ["{\"Name\":\"Sample1\",\"Drop Pools\":\"[\\\"{\\\\\\\"Pool Name\\\\\\\":\\\\\\\"None\\\\\\\",\\\\\\\"Weight\\\\\\\":\\\\\\\"50\\\\\\\",\\\\\\\"Min Amount\\\\\\\":\\\\\\\"0\\\\\\\",\\\\\\\"Max Amount\\\\\\\":\\\\\\\"0\\\\\\\"}\\\",\\\"{\\\\\\\"Pool Name\\\\\\\":\\\\\\\"Common\\\\\\\",\\\\\\\"Weight\\\\\\\":\\\\\\\"45\\\\\\\",\\\\\\\"Min Amount\\\\\\\":\\\\\\\"1\\\\\\\",\\\\\\\"Max Amount\\\\\\\":\\\\\\\"1\\\\\\\"}\\\",\\\"{\\\\\\\"Pool Name\\\\\\\":\\\\\\\"Rare\\\\\\\",\\\\\\\"Weight\\\\\\\":\\\\\\\"15\\\\\\\",\\\\\\\"Min Amount\\\\\\\":\\\\\\\"1\\\\\\\",\\\\\\\"Max Amount\\\\\\\":\\\\\\\"1\\\\\\\"}\\\",\\\"{\\\\\\\"Pool Name\\\\\\\":\\\\\\\"Super Rare\\\\\\\",\\\\\\\"Weight\\\\\\\":\\\\\\\"1\\\\\\\",\\\\\\\"Min Amount\\\\\\\":\\\\\\\"1\\\\\\\",\\\\\\\"Max Amount\\\\\\\":\\\\\\\"1\\\\\\\"}\\\"]\"}","{\"Name\":\"Sample2\",\"Drop Pools\":\"[\\\"{\\\\\\\"Pool Name\\\\\\\":\\\\\\\"None\\\\\\\",\\\\\\\"Weight\\\\\\\":\\\\\\\"50\\\\\\\",\\\\\\\"Min Amount\\\\\\\":\\\\\\\"0\\\\\\\",\\\\\\\"Max Amount\\\\\\\":\\\\\\\"0\\\\\\\"}\\\",\\\"{\\\\\\\"Pool Name\\\\\\\":\\\\\\\"Common\\\\\\\",\\\\\\\"Weight\\\\\\\":\\\\\\\"45\\\\\\\",\\\\\\\"Min Amount\\\\\\\":\\\\\\\"1\\\\\\\",\\\\\\\"Max Amount\\\\\\\":\\\\\\\"1\\\\\\\"}\\\",\\\"{\\\\\\\"Pool Name\\\\\\\":\\\\\\\"Rare\\\\\\\",\\\\\\\"Weight\\\\\\\":\\\\\\\"15\\\\\\\",\\\\\\\"Min Amount\\\\\\\":\\\\\\\"1\\\\\\\",\\\\\\\"Max Amount\\\\\\\":\\\\\\\"1\\\\\\\"}\\\",\\\"{\\\\\\\"Pool Name\\\\\\\":\\\\\\\"Super Rare\\\\\\\",\\\\\\\"Weight\\\\\\\":\\\\\\\"1\\\\\\\",\\\\\\\"Min Amount\\\\\\\":\\\\\\\"1\\\\\\\",\\\\\\\"Max Amount\\\\\\\":\\\\\\\"1\\\\\\\"}\\\"]\"}","{\"Name\":\"Sample3\",\"Drop Pools\":\"[\\\"{\\\\\\\"Pool Name\\\\\\\":\\\\\\\"None\\\\\\\",\\\\\\\"Weight\\\\\\\":\\\\\\\"50\\\\\\\",\\\\\\\"Min Amount\\\\\\\":\\\\\\\"0\\\\\\\",\\\\\\\"Max Amount\\\\\\\":\\\\\\\"0\\\\\\\"}\\\",\\\"{\\\\\\\"Pool Name\\\\\\\":\\\\\\\"Common\\\\\\\",\\\\\\\"Weight\\\\\\\":\\\\\\\"45\\\\\\\",\\\\\\\"Min Amount\\\\\\\":\\\\\\\"1\\\\\\\",\\\\\\\"Max Amount\\\\\\\":\\\\\\\"1\\\\\\\"}\\\",\\\"{\\\\\\\"Pool Name\\\\\\\":\\\\\\\"Rare\\\\\\\",\\\\\\\"Weight\\\\\\\":\\\\\\\"15\\\\\\\",\\\\\\\"Min Amount\\\\\\\":\\\\\\\"1\\\\\\\",\\\\\\\"Max Amount\\\\\\\":\\\\\\\"1\\\\\\\"}\\\",\\\"{\\\\\\\"Pool Name\\\\\\\":\\\\\\\"Super Rare\\\\\\\",\\\\\\\"Weight\\\\\\\":\\\\\\\"1\\\\\\\",\\\\\\\"Min Amount\\\\\\\":\\\\\\\"1\\\\\\\",\\\\\\\"Max Amount\\\\\\\":\\\\\\\"1\\\\\\\"}\\\"]\"}"]
 *
...
class DropPool {
	constructor(name, weight = 1, minAmount = 0, maxAmount = 0, level = 0) {
		this.name = name;
...
dingk.ItemPools.params = PluginManager.parameters('dingk_ItemPools');
dingk.ItemPools.tables = dingk.ItemPools.params['Global Loot Tables'];
dingk.ItemPools.displaySingle = dingk.ItemPools.params['Single Item'];
dingk.ItemPools.displayMultiple = dingk.ItemPools.params['Multiple Items'];

//------------------------------------------------------------------------------
// DataManager
//------------------------------------------------------------------------------

dingk.ItemPools.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
	if (!dingk.ItemPools.DataManager_isDatabaseLoaded.call(this)) return false;
	if (!dingk.ItemPools._loaded) {
		this.process_dingk_ItemPools_lootTables();
		this.getItemNames();
		this.getWeaponNames();
		this.getArmorNames();
		this.process_dingk_ItemPools_items($dataItems);
		this.process_dingk_ItemPools_items($dataWeapons);
		this.process_dingk_ItemPools_items($dataArmors);
		this.process_dingk_ItemPools_enemies();
		dingk.ItemPools._loaded = true;
	}
	return true;
};

DataManager.process_dingk_ItemPools_lootTables = function() {
	let jsonTables = JSON.parse(dingk.ItemPools.tables);
...
DataManager.process_dingk_ItemPools_items = function(group) {
...
DataManager.process_dingk_ItemPools_enemies = function() {
...
dingk.ItemPools.Game_Enemy_makeDropItems = Game_Enemy.prototype.makeDropItems;
Game_Enemy.prototype.makeDropItems = function() {
	let drops = dingk.ItemPools.Game_Enemy_makeDropItems.call(this);
...
Game_Enemy.prototype.getDropCategory = function() {
	...
	for (let table of this.enemy().dropTables) {
		let pool = dingk.ItemPools.getDropCategory(table);
...
Game_Enemy.prototype.getItemsFromPool = function(pools) {
	if (Imported.dingk_EquipLevels && dingk.EquipLevels.enableEnemyLevels) {
		...
		if (Imported.YEP_EnemyLevels) {
			return dingk.ItemPools.getItemsFromPool(pools, this.level);
		}
	...
	return dingk.ItemPools.getItemsFromPool(pools);
};
...
dingk.ItemPools.GI_pluginCommand = Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function(command, args) {
	dingk.ItemPools.GI_pluginCommand.call(this, command, args);
	...
	if (cmd.match(rx1)) {
		...
		let drops = dingk.ItemPools.getItemsFromPool([pool]);
		dingk.ItemPools.giveDrops(drops);
...
dingk.ItemPools.getItemsFromPool = function(pools, level) {
	let drops = [];
	for (let pool of pools) {
		let amount = dingk.ItemPools.randomInt(pool.minAmount, pool.maxAmount);
...
dingk.ItemPools.getDropCategory = function(table) {
	if (!table) return;
...
dingk.ItemPools.giveDrops = function(drops) {
	...
	for (let item of drops) {
		...
		if (amount > 0) {
			if (amount === 1) {
				let fmt = dingk.ItemPools.displaySingle;
				if (fmt) $gameMessage.add(fmt.format(icon, name));
			} else {
				let fmt = dingk.ItemPools.displayMultiple;
...
dingk.ItemPools.randomInt = function(min, max) {
	if (max < min) {
		let tmp = min;
		min = max;
		max = tmp;
